...
firebase.initializeApp({
    apiKey: 'AIzaSyDaA6F5ZJNPK04QqpaltpGGk3zZX-2ekTY',
    authDomain: 'chat-app-4bd88.firebaseapp.com',
    projectId: 'chat-app-4bd88',
    storageBucket: 'chat-app-4bd88.appspot.com',
    messagingSenderId: '423121418848',
    appId: '1:423121418848:web:c2f9b94c5f3bb4ce04e105'
})
            ...
            <div className="flex items-center justify-center shadow-md h-full">
                <div className="flex flex-col items-center justify-center max-w-xl w-full mx-4 p-8 rounded-md shadow-card bg-white dark:bg-coolDark-600 transition-all">
                    <h2 className="mb-2 text-3xl flex items-center">
                        ...
                        BADD Solutions | Chat app
                    </h2>
                    <p className="mb-8 text-lg text-center">Lets chat guys :)</p>
                    <button
